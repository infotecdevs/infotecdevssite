...
const Skills = () => {
  return (
    <>
      <span id="about"></span>
      <div className="py-8 sm:py-12 md:py-20 px-8 sm:px-12 md:px-20 bg-[#f3f3f3]">
        <div className="mx-2 md:mx-5">
          <div className=" grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-2 md:gap-4">
            {skillsData.map((skill, i) => (
              <div
                key={i}
                className="bg-white card group space-y-3 p-4 rounded-md hover:bg-violet-950 hover:text-white duration-300
